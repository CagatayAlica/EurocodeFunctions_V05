...
import FSA.pycufsm.cfsm
from FSA.pycufsm.analysis import analysis
from FSA.pycufsm.helpers import inputs_new_to_old, lengths_recommend
from FSA.pycufsm.preprocess import stress_gen, yield_mp
from FSA.pycufsm.types import (
    BC,
    Analysis_Config,
    ArrayLike,
    Cfsm_Config,
...
def strip(
    ...
    if cfsm_analysis == 1:
        ...
        [
            ...
            n_local_modes,
            dof_perm,
        ] = FSA.pycufsm.cfsm.base_properties(nodes=nodes_base, elements=elements)
        [r_x, r_z, r_yd, r_ys, r_ud] = FSA.pycufsm.cfsm.mode_constr(
            nodes=nodes_base,
            elements=elements,
        ...
        [d_y, n_global_modes] = FSA.pycufsm.cfsm.y_dofs(
            nodes=nodes_base,
            elements=elements,
            main_nodes=main_nodes,
    ...
    for i, length in enumerate(lengths):
        ...
        if cfsm_analysis == 1:
            ...
            b_v_l = FSA.pycufsm.cfsm.base_column(
        ...
        if BC_flag == 1:
            ...
            # BWS June 5 2006)
            r_user = FSA.pycufsm.cfsm.constr_user(nodes=nodes, constraints=constraints, m_a=m_a)
        ...
        if cfsm_analysis == 1:
            ...
            b_v = FSA.pycufsm.cfsm.base_update(
                GBT_con=GBT_con,
                b_v_l=b_v_l,
                length=length,
                m_a=m_a,
            ...
            b_v = FSA.pycufsm.cfsm.mode_select(
                b_v=b_v,
                n_global_modes=n_global_modes,
                n_dist_modes=n_dist_modes,
                n_local_modes=n_local_modes,
...
def m_recommend(
    ...
    _, _, _, _, _, _, n_dist_modes, n_local_modes, _ = FSA.pycufsm.cfsm.base_properties(nodes=nodes, elements=elements)
