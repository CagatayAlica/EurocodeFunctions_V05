...
class bendWeakLip:
    ...
    def calcs_BendingWeakLip(self):
        ...
        bot_lip_lamp = Sec4.lamp(self.sec.cc, self.sec.tcore, bot_lip_ksigma, scomed, True)
        ...
        web_lamp = Sec4.lamp(self.sec.aa, self.sec.tcore, web_ksigma, scomed, False)
        ...
        # Results
        self.Ieff = intprop.calcProps(self.BendWeakLip_elementData2)[4]
        self.xgc = intprop.calcProps(self.BendWeakLip_elementData2)[3]
        self.xgct = self.sec.bb - intprop.calcProps(self.BendWeakLip_elementData2)[3]
        self.Weff = intprop.calcProps(self.BendWeakLip_elementData2)[4] / (
            max(self.xgc, self.xgct))
